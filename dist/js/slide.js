...
function SlideBar1(data){
	...
	var oShowArea1 = null;
	if(data.showArea1){
        oShowArea1 = document.getElementById(data.showArea1);
	}
	if(oShowArea1){
		_this.addScale(oSlideBar, interval, maxNumber, barLength);
		_this.inputBlur(oActionBlock, oActionBar, maxNumber, barLength, oShowArea1);
		_this.clickSlide(oActionBlock, oActionBar, oSlideBar, maxNumber, barLength, oShowArea1);
		_this.drag(oActionBlock, oActionBar, maxNumber, barLength, oShowArea1);
	}
	else{
		_this.addScale(oSlideBar, interval, maxNumber, barLength);
		_this.clickSlide(oActionBlock, oActionBar, oSlideBar, maxNumber, barLength);
...
function SlideBar2(data){
	...
	var oShowArea2 = null;
	if(data.showArea2){
		oShowArea2 = document.getElementById(data.showArea2);	
	}
	if(oShowArea2){
		_this.addScale(oSlideBar, interval, maxNumber, barLength);
		_this.inputBlur(oActionBlock, oActionBar, maxNumber, barLength, oShowArea2);
		_this.clickSlide(oActionBlock, oActionBar, oSlideBar, maxNumber, barLength, oShowArea2);
		_this.drag(oActionBlock, oActionBar, maxNumber, barLength, oShowArea2);
	}
	else{
		_this.addScale(oSlideBar, interval, maxNumber, barLength);
		_this.clickSlide(oActionBlock, oActionBar, oSlideBar, maxNumber, barLength);
...
SlideBar.prototype = {
	...
	addScale : function(slideBar, interval, total, barLength){
		...
		for (var i = 0; i < num + 1; i++) {
			...
			oScale.style.height = '5px';
            oScale.style.position = 'absolute';
            oScale.style.top = '10px';
			...
			var oActionBar = document.getElementById('action-bar');
			oActionBar.style.width="70px";
			var oActionBlock = document.getElementById('action-block');
			oActionBlock.style.left="1.4rem";
		
			var oText = document.createElement('div');
			oText.style.position = 'absolute';
			oText.style.top = '5px';
            oText.style.height = '5px';
            oText.style.fontSize = '0px';
...
SlideBar1.prototype = {
	...
	addScale : function(slideBar, interval, total, barLength){
		...
		for (var i = 0; i < num + 1; i++) {
			...
			var oActionBar = document.getElementById('action-bar1');
			oActionBar.style.width="70px";
			var oActionBlock = document.getElementById('action-block1');
			oActionBlock.style.left="1.4rem";
...
SlideBar2.prototype = {
	...
	addScale : function(slideBar, interval, total, barLength){
		...
		for (var i = 0; i < num + 1; i++) {
			...
			var oActionBar = document.getElementById('action-bar2');
			oActionBar.style.width="70px";
			var oActionBlock = document.getElementById('action-block2');
			oActionBlock.style.left="1.4rem";
