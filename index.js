...
function handleProgress(video, progressBar) {
	currentnum=s_to_hs(video.currentTime)
	
	 $('#currentnum').html(currentnum);
	 allTimes=s_to_hs(video.duration)
...
function buildControls(skin) {
    ...
    html.push( '<div id="currentnum">00:00</div>',  '<div class="progress">', '<div class="progress__filled"></div>', '</div>', '<div id="allTimes">00:00</div>', '<button class="' + skin + '__button fullscreen" title="Full Screen">' + iconExpand + '</button>');
